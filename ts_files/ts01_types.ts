...
let a : number;     // sadece sayı atanabilir
let b : string;     // sadece metin atanabilir
let c : boolean;    // sadece boolean değer atanabilir
let d : any;        // herhangi bir değer atanabilir
let e : unknown;    // herhangi bir değer atanabilir ama ondan constructor oluşturulamaz, ona atanan değer ne olursa olsun o değerin veri tipi ile ilgili metotlara, özelliklere ulaşamaz.
...
let sayiDizisi1: number[] = [15,84,95,"abdullah bin ubey"];
let sayiDizisi2: Array<number> = [946,854,61,8];

let stringDizisi1: string[] = ["ali", "ömer", 'ebu bekir', "osman"];
let stringDizisi2: Array<string> = ["talha", 'zübeyr', "elyesa", "zekeriya"];

let booleanDizis1: boolean[] = [true, false ];
let booleanDizisi2: Array<boolean> = [false, true];

let anyDizisi1: any[] = [549, "yalçın kara", true];
let anyDizisi2: Array<any> = ["harun çiftçi", false, true, "ahmet", 875];
...
let dizi1: [string, boolean, string, number] = ["muhammed", true, "matematik", 949];
...
let ikili_tip: boolean | string = "murat";
